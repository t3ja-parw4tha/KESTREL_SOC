...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-blue-500/30 overflow-x-hidden transition-colors duration-500">
      <a
        href="#main-content"
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute -top-[40%] -left-[10%] w-[70%] h-[70%] rounded-full bg-blue-400/20 dark:bg-blue-900/10 blur-[120px] mix-blend-multiply dark:mix-blend-screen transition-colors duration-700 animate-float" />
        <div className="absolute top-[20%] -right-[20%] w-[60%] h-[60%] rounded-full bg-indigo-400/20 dark:bg-indigo-900/10 blur-[120px] mix-blend-multiply dark:mix-blend-screen transition-colors duration-700 animate-float [animation-delay:3s]" />
      </div>

      <header className="relative z-50 border-b border-border bg-card/40 backdrop-blur-xl transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl gradient-primary shadow-lg shadow-blue-500/20">
              <Shield className="w-5 h-5 text-white" />
            </div>
            <span className="text-2xl font-bold tracking-tight text-foreground">KESTREL</span>
          </div>
          <nav className="flex items-center gap-6">
            ...
            <Link
              to="/login"
              className="text-sm px-5 py-2.5 rounded-full gradient-primary text-white font-semibold hover:opacity-90 transition-all shadow-lg shadow-blue-500/20"
            >
              Sign In
            </Link>
          </nav>
      ...
      <main id="main-content" className="relative z-10" tabIndex={-1}>
        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 text-center animate-slide-up">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8">
              <span className="text-foreground">Cut through the noise.</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/login"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-full gradient-primary text-white font-bold text-lg hover:opacity-90 hover:scale-105 transition-all duration-300 shadow-xl shadow-blue-500/20"
              >
                Launch Console
              ...
              <Link
                to="/setup"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-border bg-card text-foreground font-semibold text-lg hover:bg-muted/50 transition-colors backdrop-blur-md"
              >
                Initial Setup
        ...
        <section className="max-w-6xl mx-auto px-6 pb-32">
          <div className="relative rounded-2xl border border-border bg-card backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.1)] dark:shadow-[0_0_50px_rgba(99,102,241,0.15)] overflow-hidden hover:shadow-[0_0_80px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_0_80px_rgba(99,102,241,0.25)] transition-all duration-500">
            ...
            <div className="h-10 border-b border-border bg-card/50 flex items-center px-4 gap-2">
              ...
              <div className="ml-6 px-4 py-1 text-xs text-muted-foreground font-mono bg-muted/50 rounded-md border border-border flex-1 max-w-md flex items-center gap-2 m-auto justify-center">
            ...
            <div className="flex h-[500px] text-left">
              ...
              {/* Sidebar */}
              <div className="w-48 border-r border-border p-3 flex flex-col gap-2 bg-card/30">
                <div className="flex items-center gap-2 mb-6 px-2 mt-2">
                  <Shield className="w-5 h-5 text-blue-500" />
                  <span className="font-bold text-sm text-foreground">KESTREL</span>
                </div>
                ...
                <div className="px-3 py-2 rounded-lg text-muted-foreground text-xs font-medium hover:bg-muted/50 transition-colors flex items-center gap-2">
              ...
              <div className="flex-1 p-6 flex flex-col gap-6 bg-gradient-to-br from-transparent to-indigo-900/5 overflow-hidden">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <h2 className="text-xl font-bold text-foreground mb-1">Overview</h2>
                    <p className="text-xs text-muted-foreground">Last 24 hours across all active sources.</p>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-card border border-border shadow-sm">
                    <p className="text-xs text-muted-foreground mb-2">AI Triage Rate</p>
                    <div className="flex items-end justify-between">
                      <span className="text-2xl font-bold text-emerald-500 dark:text-emerald-400">98.5%</span>
                      <span className="text-xs text-muted-foreground">of 1,204 total</span>
                    </div>
                  </div>
                  <div className="p-4 rounded-xl bg-card border border-border shadow-sm">
                    <p className="text-xs text-muted-foreground mb-2">Playbooks Executed</p>
                    <div className="flex items-end justify-between">
                ...
                <div className="flex-1 flex gap-4 h-full min-h-0">
                  ...
                  {/* Table */}
                  <div className="flex-[2] rounded-xl bg-card border border-border flex flex-col overflow-hidden shadow-sm">
                    <div className="border-b border-border px-4 py-3 flex text-xs font-semibold text-muted-foreground uppercase tracking-wider bg-muted/20">
                      <div className="w-24">Severity</div>
                      <div className="flex-1">Alert Title</div>
                      <div className="w-32 text-right">Source</div>
                    </div>
                    <div className="flex flex-col">
                      <div className="px-4 py-3 flex items-center text-xs border-b border-border/50 hover:bg-muted/30 cursor-pointer bg-blue-500/5">
                        ...
                        <div className="flex-1 font-medium text-foreground truncate pr-4">Suspicious PowerShell Execution detected on DC-01</div>
                        <div className="w-32 text-right text-muted-foreground">CrowdStrike</div>
                      </div>
                      <div className="px-4 py-3 flex items-center text-xs border-b border-border/50 hover:bg-muted/30 cursor-pointer">
                        ...
                        <div className="flex-1 font-medium text-foreground truncate pr-4">Multiple failed SSH logins for user 'root'</div>
                        <div className="w-32 text-right text-muted-foreground">Syslog</div>
                      </div>
                      <div className="px-4 py-3 flex items-center text-xs border-b border-border/50 hover:bg-muted/30 cursor-pointer">
                        ...
                        <div className="flex-1 font-medium text-foreground truncate pr-4">Unusual outbound traffic to known Tor exit node</div>
                        <div className="w-32 text-right text-muted-foreground">Suricata</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-[1] rounded-xl bg-gradient-to-br from-indigo-500/10 to-blue-500/5 border border-indigo-500/20 p-4 flex flex-col gap-3 shadow-sm">
                    ...
                    <div className="text-sm font-medium text-foreground">PowerShell Execution (DC-01)</div>
                    ...
                    <div className="mt-auto space-y-2">
                      <span className="block text-[10px] font-semibold text-muted-foreground uppercase">Recommended Actions</span>
                      <div className="bg-muted/30 border border-border rounded-lg p-2 text-xs flex items-center gap-2 cursor-pointer hover:bg-muted/50 transition-colors text-foreground">
                        <Shield className="w-3 h-3 text-emerald-500" /> Contain Host (DC-01)
                      </div>
                      <div className="bg-muted/30 border border-border rounded-lg p-2 text-xs flex items-center gap-2 cursor-pointer hover:bg-muted/50 transition-colors opacity-60 text-foreground">
        ...
        {/* Features Grid */}
        <section className="relative z-20 py-24 bg-card/40 border-y border-border backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-children">
              {features.map((feat) => (
                <div
                  key={feat.title}
                  className={`group relative p-8 rounded-2xl bg-card border border-border hover:border-blue-500/30 hover-scale transition-all duration-300 ${feat.glow} shadow-sm`}
                >
                  ...
                  <p className="text-muted-foreground tracking-wide transition-colors leading-relaxed">
                    {feat.description}
                  </p>
                </div>
              ))}
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full gradient-primary text-white font-bold text-lg hover:opacity-90 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.6)] transition-all duration-300 transform hover:-translate-y-1"
            >
      ...
      <footer className="relative z-20 border-t border-border bg-background py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Shield className="w-5 h-5 text-blue-500" />
            <span className="font-bold text-foreground tracking-widest">KESTREL</span>
          </div>
